...
import { KitchenOrderQueueSection } from './sections/KitchenOrderQueueSection';
        ...
        >
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Manage food preparation, cooking status, and delivery coordination
            </p>
          </div>
        </motion.div>
