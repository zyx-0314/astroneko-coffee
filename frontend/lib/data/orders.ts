...
// Get the primary/most important status from an array of statuses
export function getPrimaryStatus(statuses: OrderStatus[]): OrderStatus {
  ...
  // Return the highest priority status found in the array
